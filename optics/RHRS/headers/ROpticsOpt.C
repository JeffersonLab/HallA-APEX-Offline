...
UInt_t ROpticsOpt::LoadRawData(TString DataFileName, UInt_t NLoad, UInt_t MaxDataPerGroup)
{
	...
	//// This block was commented out by John
...
TCanvas * ROpticsOpt::CheckSieve(Int_t PlotFoilID)
{
    ...
    const UInt_t nplot = (PlotFoilID == -1) ? NFoils : 11;
    //const UInt_t nplot = PlotFoilID ;
    //const UInt_t nplot = 1 ;
...
std::pair<Double_t,Double_t> ROpticsOpt::SumSquareDPhi()
{
    ...
    return std::make_pair(rmsphi,rmsdy);  //Use for opt to angles
