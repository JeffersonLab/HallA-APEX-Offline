...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////
    TString OldComments;
    Int_t LoadDataBase(TString DataBaseName, int DataBaseNum); // Database file -> Memory
    Int_t SaveDataBase(TString DataBaseName, int DataBaseNum); // Memory -> Database file
    ...
    Double_t SumSquareXpos(void);
    Double_t SumSquareYpos(void);
    ...
    std::vector<THaMatrixElement> * fCurrentMatrixElems2;
    // initial matrix elements
    std::vector<THaMatrixElement> fTMatrixElems2;
    std::vector<THaMatrixElement> fDMatrixElems2;
    std::vector<THaMatrixElement> fPMatrixElems2;
    std::vector<THaMatrixElement> fPTAMatrixElems2; // involves abs(theta_fp)
    std::vector<THaMatrixElement> fYMatrixElems2;
    std::vector<THaMatrixElement> fYTAMatrixElems2; // involves abs(theta_fp)
    std::vector<THaMatrixElement> fFPMatrixElems2; // matrix elements used in
    std::vector<THaMatrixElement> fRMatrixElems2; // Path-length corrections (meters)
