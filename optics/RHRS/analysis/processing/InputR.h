...
//const Double_t SieveXbyRowEven[] = { -4 * XbyRow, -3 * XbyRow, -2 * XbyRow, -1 * XbyRow, 0*XbyRow, 1*XbyRow, 2 * XbyRow, 3 * XbyRow, 4 * XbyRow, 1e36}; // vertical positions of the sieve holes when the column number is odd, column number starts with 0
//const Double_t SieveXbyRowOdd[] = {-3.5 * XbyRow, -2.5 * XbyRow, -1.5 * XbyRow, -0.5 * XbyRow, 0.5 * XbyRow, 1.5 * XbyRow, 2.5 * XbyRow, 3.5 * XbyRow, 1e36}; 
//const UInt_t NSieveRow = 9; 
