...
class LOpticsOpt : public THaTrackingDetector {
	...
	public:
		...
		//		TCanvas * CheckSieve(UInt_t SpecialNLoad= NFiols, Int_t print = 1);
		void CheckSieve(UInt_t SpecialNLoad= NFiols, Int_t print = 1);
		...
		//		CheckVertex(void);
		void CheckVertex(Int_t print = 1);
		void CheckVertexRes(Int_t print = 1);
		void CheckVertexDiff(Int_t print = 1);
...
// 		 const std::vector<double> &a);
		...
		Bool_t foil_on[8] {true, true, true, true, true, true, true, true}; // set-up true/false condition for all foils
