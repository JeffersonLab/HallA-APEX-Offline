...
void horizontal_correction_right(Double_t correction = 0.0){
  ...
  // raster limits
  Double_t Lrby_l = -0.003;//0.0014;
  Double_t Lrby_h = 0.007;//0.0030;

  Double_t Lrbx_l = -0.0012;//-0.0022;
  Double_t Lrbx_h = 0.0000; //-0.0011;

  // BPM limits
  Double_t BPM_lim_l = -0.001;
  Double_t BPM_lim_h = 0.008;
  ...
  Double_t l_x1 = 0.0047;
  Double_t l_y1 = 20100;
  Double_t l_x2 = 0.0066;
  Double_t l_y2 = 39400;
  ...
  // if time correction is preset

  if(correction != 0.0){
    time_2_diff = correction;
    cout << "Set time correction to preset value of " << time_2_diff << endl;
  }
  ...
  h_rcurr_adj->GetYaxis()->SetTitleOffset(2.0);
   ...
   c3->Print(Form("horizontal_foils/corrections/raster_shape_%d.pdf",run_nos[0]));
   c4->Print(Form("horizontal_foils/corrections/rast_BPM_%d.pdf",run_nos[0]));
   c5->Print(Form("horizontal_foils/corrections/rast_y_%d.pdf",run_nos[0]));
   c7->Print(Form("horizontal_foils/corrections/curr_vs_curr_adj_%d.pdf",run_nos[0]));
