...
/* // rastered beam */
const Double_t BeamX_average_V1 = 0.001236;
const Double_t BeamY_average_V1 = 0.002553;

const Double_t BeamX_average_V2 = -0.000819;
const Double_t BeamY_average_V2 = 0.002697;

const Double_t BeamX_average_V3 = -0.00244;
const Double_t BeamY_average_V3 = 0.002726;
...
//const Double_t targetfoils[] = { -0.205, -0.005, 0.195 }; * this *
...
//const Double_t targetfoils[] = { -0.305,  -0.224, -0.155,  -0.08, 0.07, 0.145, 0.214, 0.295 };

// from Silviu's email of targetfoil positions
const Double_t targetfoils[] = { -0.288,  -0.207, -0.138,  -0.063, 0.087, 0.162, 0.231, 0.312 };


// figures based on old values for vertical target foils (in fact should look at their offset in wiki)
