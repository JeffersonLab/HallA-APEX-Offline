...
void Ls0_cali(Int_t runno)
{
  ...
  Double_t lfgain;
  ofstream myfile;
  myfile.open(Form("DB/L_s0_ped_%i.txt",runno));//,fstream::app);
  ...
  c1->Divide(2,1);
  c1->cd(1);
  TH1F *tt1 = new TH1F("tt1","FADC L.s0.la",500,6500,7000);
  ...
  c1->cd(2);
  TH1F *tt2 = new TH1F("tt2","FADC Ls0.la_p",300,100,1300);
  ...
  c2->Divide(2,1);
  c2->cd(1);
  TH1F *tt4 = new TH1F("tt4","FADC L.s0.ra",500,6500,7000);
  ...
  c2->cd(2);
  TH1F *tt5 = new TH1F("tt5","FADC L.s0.ra_p",300,100,1300);
  ...
  c1->Print(Form("plots/Ls0_%i.pdf[",runno));
  c1->Print(Form("plots/Ls0_%i.pdf",runno));
  c2->Print(Form("plots/Ls0_%i.pdf",runno));
  c2->Print(Form("plots/Ls0_%i.pdf]",runno));
